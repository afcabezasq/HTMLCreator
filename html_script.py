...
file_path = "messages.xlsx"  # Change this to your actual file
...
# Convert date column to datetime using the format 'yyyy/mm/dd HH:MN:SS'
...
# Group messages by conversation group and 24-hour periods
   ...
   for group in conversation_groups:
       ...
       if not daily_messages.empty:
           ...
           for _, row in daily_messages.iterrows():
               ...
               alignment = "sender" if is_sender else "receiver"
